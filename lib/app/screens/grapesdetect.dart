...
class GrapesDiesease extends StatefulWidget {
  @override
  _GrapesDieseaseState createState() => _GrapesDieseaseState();
}

class _GrapesDieseaseState extends State<GrapesDiesease> {
  List _outputs;
  File _image;
  bool _loading = false;
